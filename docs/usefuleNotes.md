### 1. Do need to define the queue name in the file that create the channel and publish event to exchange right? what is the general approach of setting the queue name?
